...
--
-- Host: localhost:8889
-- Generation Time: Apr 13, 2017 at 10:58 PM
...
CREATE TABLE `tbl_comments` (
  `comments_id` tinyint(4) NOT NULL,
  `comments_movie` varchar(10) NOT NULL,
  `comments_post` text NOT NULL,
  `comments_user` varchar(100) NOT NULL
...
INSERT INTO `tbl_comments` (`comments_id`, `comments_movie`, `comments_post`, `comments_user`) VALUES
(1, '2', 'this movie is the possession', 'bob'),
(2, '2', 'this is a second comment about possesion', 'eva'),
(3, '1', 'this one is on tremors but is the third comment in the db', 'bob'),
(4, '4', 'this comment skips right to last exorcism ', 'sam'),
(11, '3', 'comment on pet seminary', 'jessica'),
(12, '5', 'comment at the end of the street', 'billy'),
(13, '16', 'who you gunna call?', 'ed'),
(15, '2', 'new comment', '');
...
(4, 'molly', 'millions', 'S_Samuri', 'overdrive', '1', '::1');
...
--
ALTER TABLE `tbl_comments`
  MODIFY `comments_id` tinyint(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `tbl_movies`
  MODIFY `movies_id` smallint(4) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `tbl_user`
  MODIFY `user_id` smallint(4) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;